    ...
    <main className=" text-white">
      ...
      <div className='flex flex-col  items-center lg:flex-row pb-32'>
        ...
        <p className="text-lg text-white text-left m-5 md:mx-20 ">I am a current student pursuing a bachelors
          ...
          <br/>
          <button className='mt-5 px-3 object-center bg-white border-white rounded-lg border-4 text-black font-bold hover:bg-black hover:text-white'>View Resume</button>
          </p>
      </div>
    </main>
  )
