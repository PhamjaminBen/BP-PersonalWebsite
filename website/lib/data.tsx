...
export const projects = [
	...
	},
	{
		...
		body: "This website was built in order to practice my skills in next.js, tailwind css, and other external dynamic styling libraries, such as Framer and GSAP.\
    I also made this to give a presentable and response website as an alternative to a resume for a more immersive experience for those looking into my qualifications.",
